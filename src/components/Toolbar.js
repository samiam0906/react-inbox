  ...
  return (
    <div className="row toolbar">
      <div className="col-md-12">
        ...
        <button className="btn btn-default" disabled={disabledClass} onClick={ markAsRead }>
          Mark As Read
        </button>

        <button className="btn btn-default" disabled={disabledClass} onClick={ markAsUnread }>
          Mark As Unread
        </button>
